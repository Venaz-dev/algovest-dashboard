...
const Icons = ({ name, size, color, fill, className }) => {
  return name === "check" ? (
    ...
    >
      <path
        d="M227.5 0C101.855 0 0 101.855 0 227.5S101.855 455 227.5 455 455 353.145 455 227.5 353.145 0 227.5 0zm49.272 334.411l-21.248 21.178L127.852 227.5 255.524 99.411l21.248 21.178L170.209 227.5l106.563 106.911z"
        fill="gray"
      />
    </svg>
  ) : name === "metamask" ? (
    ...
    <svg width={15} height={18} fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M1.5 15V7.5h9v.75c.525 0 1.027.075 1.5.217V7.5c0-.825-.675-1.5-1.5-1.5h-.75V4.5C9.75 2.43 8.07.75 6 .75 3.93.75 2.25 2.43 2.25 4.5V6H1.5C.675 6 0 6.675 0 7.5V15c0 .825.675 1.5 1.5 1.5h4.695a5.35 5.35 0 0 1-.728-1.5H1.5ZM3.75 4.5A2.247 2.247 0 0 1 6 2.25 2.247 2.247 0 0 1 8.25 4.5V6h-4.5V4.5Z"
        fill={color || "gray"}
      />
      <path
        d="M10.5 9.75c-2.07 0-3.75 1.68-3.75 3.75 0 2.07 1.68 3.75 3.75 3.75 2.07 0 3.75-1.68 3.75-3.75 0-2.07-1.68-3.75-3.75-3.75Zm1.238 5.512-1.613-1.612v-2.4h.75v2.092l1.387 1.388-.524.532Z"
        fill={color || "gray"}
      />
    </svg>
  ) : null;
