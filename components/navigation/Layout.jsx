...
const Layout = ({children, balance, setBalance, currentAccount, setCurrentAccount}) => {
  ...
  const detectProvider = () => {
    ...
    if (window.ethereum) {
      ...
      window.alert("No Ethereum browser detected! Install MetaMask extension to continue...");
    }
    return provider;
  };
    ...
    const networkId = await web3.eth.net.getId();
      ...
      // 0x822480D4eFD781C696272F0aca9980395Db72cc0 // address of token
          ...
          //  const nameoftoken = await algoPooltokencontract.methods;
           ...
           const rewardTokenmeth = await algoPooltokencontract.methods.rewardAPY().method();
